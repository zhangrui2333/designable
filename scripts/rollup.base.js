...
const presets = () => {
  const externals = {
    ...
    '@edan/designable-shared': 'Designable.Shared',
    '@edan/designable-core': 'Designable.Core',
    '@edan/designable-react': 'Designable.React',
    '@edan/designable-react-sandbox': 'Designable.ReactSandbox',
    '@edan/designable-react-settings-form': 'Designable.ReactSettingsForm',
  }
  return [
    typescript({
